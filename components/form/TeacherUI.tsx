    ...
    <>
      ...
      >
        ...
        <div className="relative py-2 px-6  md:px-12">
          <h2 className="w-40 text-center bg-indigo-500 rounded-t-md px-4 text-left block text-2xl font-black leading-[1.5] tracking-normal text-white antialiased">
            {specialty}
          </h2>
          <h5 className="w-40 bg-gray-900 text-center rounded-b-md px-2 py-1 block mb-4 text-xl antialiased leading-snug tracking-normal text-white shadow">
            {name}
          </h5>
        </div>
      </div>
